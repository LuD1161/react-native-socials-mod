...
var getContainerAspectRatio = function (aspectRatios) {
  var reverseAspectRatios = aspectRatios.map(function (aspectRatio) {
  ...
  if (aspectRatios.length === 3) {
    var cumulatedAspectRatioRightPart =
  ...
  if (aspectRatios.length === 4) {
    var cumulatedAspectRatioRightPart =
      reverseAspectRatios[1] + reverseAspectRatios[2];
    var cumulatedAspectRatioLeftPart =
...
export var ImageGallery = function (props) {
  ...
  var _a = React.useState({
    ...
    modalState = _a[0],
    setModalState = _a[1];
  var aspectRatios = medias.map(function (element) {
      ...
      >
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            ...
            >
              {medias.map(function (element, index) {
                return (
                  <Image
                    key={index}
